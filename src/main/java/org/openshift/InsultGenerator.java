	...
	public String generateInsult() { 
	    ...
	    testconnection = DriverManager.getConnection(databaseURL, username, password);
            ...
            returnstring += newline;
             ...
             while (rs.next()) { 
                       returnstring +=  String.format("%-30.30s %-30.30s %-30.30s %-30.30s %-30.30s  %-30.30s" + newline, rs.getString(1), rs.getString(1), rs.getString(1), rs.getString(1), rs.getString(1)); 
                      returnstring += newline;
